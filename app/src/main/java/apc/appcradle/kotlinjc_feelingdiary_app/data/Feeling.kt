...
val fearFeelingsList = listOf<Feeling>(
    Feeling("Застенчивость", fearColor200, CardState.OneFeelDescribing("Застенчивость", fearColor200)),
    Feeling("Смущение", fearColor200, CardState.OneFeelDescribing("Смущение", fearColor200)),
    Feeling("Боязнь", fearColor200, CardState.OneFeelDescribing("Боязнь", fearColor200)),
    Feeling("Подозрение", fearColor200, CardState.OneFeelDescribing("Подозрение", fearColor200)),
    Feeling("Опасение", fearColor200, CardState.OneFeelDescribing("Опасение", fearColor200)),
    Feeling("Тревога", fearColor200, CardState.OneFeelDescribing("Тревога", fearColor200)),
    Feeling("Оцепенение", fearColor200, CardState.OneFeelDescribing("Оцепенение", fearColor200)),
    Feeling("Испуг", fearColor200, CardState.OneFeelDescribing("Испуг", fearColor200)),
    Feeling("Отчаяние", fearColor200, CardState.OneFeelDescribing("Отчаяние", fearColor200)),
    Feeling("Ужас", fearColor200, CardState.OneFeelDescribing("Ужас", fearColor200)),
)
val shameFeelingsList = listOf<Feeling>(
    Feeling("Неловкость", shameColor200, CardState.OneFeelDescribing("Неловкость", shameColor200)),
    Feeling("Стеснение", shameColor200, CardState.OneFeelDescribing("Стеснение", shameColor200)),
    Feeling("Дискомфорт", shameColor200, CardState.OneFeelDescribing("Дискомфорт", shameColor200)),
